...
export const STRINGS = {
  ...
  world: {
    ...
    landmarks: {
      ...
      warships: "warships steaming out of the harbour",
      freighters: "cargo ships at anchor in a neutral harbour",
      yachts: "yachts in the bay",
      turbines: "wind turbines along the ridge",
      flare: "a gas rig burning on the hill",
      levee: "a levee along the shore",
      fence: "a fence, floodlights and a bus of the deported",
      doorway: "a queue at a lit office door",
      limousines: "a long car waiting at the revenue office",
      hospital: "a hospital with every light on",
      clinic: "a private clinic behind a gate",
      cafes: "a row of cafés with their awnings out",
      gateQueue: "a queue at the works gate",
      cranes: "cranes over half-built towers",
      tenements: "old tenements with washing on the lines",
      factory: "a factory with its chimneys going",
      containers: "containers stacked high on the docks",
      clocktower: "a clock tower, its hands moved on",
      park: "a park with benches in the sun",
      university: "a university with its gates open",
      tollgate: "a toll barrier at the university gate",
      policeVans: "police vans under a searchlight",
      leafShop: "a licensed shop with a leaf on its sign",
      prison: "a full prison, every window lit",
      openPrison: "a prison half dark, and a workshop beside it",
      cameras: "a camera on every pole",
      camerasDown: "camera poles with the cameras gone",
      loudspeakers: "loudspeakers on a pole in the square",
      billboard: "a billboard of claims answered by claims",
      packedCourt: "a court crammed with extra columns",
      court: "the highest court, as it was built",
      proppedBank: "a bank held up by timber props",
      failedBank: "a boarded bank with a queue outside",
      crown: "a crown back on the palace dome",
      stadium: "a stadium under floodlights",
      portCranes: "port cranes under a foreign flag",
    } as Record<string, string>,
  },
  /** The country on the play screen, under the card (BACKLOG-10 phase 64). */
  countryNow: {
    now: "The country now: {list}.",
    empty: "The country now: nothing built yet that history will remember.",
    /** Said when a landmark goes up, as the card after the one that built it lands. */
    rose: "Now standing in the country: {landmark}.",
  },
