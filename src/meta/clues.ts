...
export const CLUES: Readonly<Record<string, string>> = {
  ...
  finale_long_decay: "Five centuries survived, on the way down.",
  finale_long_muddle: "Five centuries survived, going nowhere much.",
  finale_long_ascent: "Five centuries survived, on the way up.",
